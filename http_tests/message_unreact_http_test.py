...
# check unreact works for one user, one message   
...
# check unreact works for one user, two messages same channel
...
# check unreact works for one user, two messages diff channel
...
# check unreact works for two users, one message   
